...
var getUIKitFileTypes = function () {
  return SendbirdSdkContext.__assign({}, UIKitFileTypes);
};
...
var getOutgoingMessageStates = function () {
  return SendbirdSdkContext.__assign({}, OutgoingMessageStates);
};
...
var getUIKitMessageTypes = function () {
  return SendbirdSdkContext.__assign({}, UIKitMessageTypes);
};
...
var getSendingMessageStatus = function () {
  return SendbirdSdkContext.__assign({}, SendingMessageStatus);
};

var reducer = function (accumulator, currentValue) {
  if (Array.isArray(currentValue)) {
    return SendbirdSdkContext.__spreadArray(SendbirdSdkContext.__spreadArray([], accumulator, true), currentValue, true);
  } else {
...
var hasSameMembers = function (a, b) {
  ...
  var sortedA = SendbirdSdkContext.__spreadArray([], a, true).sort();

  var sortedB = SendbirdSdkContext.__spreadArray([], b, true).sort();
...
var getChannelsWithUpsertedChannel = function (channels, channel) {
  ...
  return SendbirdSdkContext.__spreadArray(SendbirdSdkContext.__spreadArray(SendbirdSdkContext.__spreadArray([], channels.slice(0, targetIndex), true), [channel], false), channels.slice(targetIndex, channels.length), true);
};
...
//# sourceMappingURL=index-9855395f.js.map
