...
var index = require('./index-3fd14343.js');
...
function Accordion(_a) {
  ...
  function (value) {
    ...
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("div", {
      className: SendbirdSdkContext.__spreadArray(SendbirdSdkContext.__spreadArray([], Array.isArray(className) ? className : [className], true), ['sendbird-accordion__panel-header'], false).join(' '),
      id: id,
      role: "switch",
      "aria-checked": false,
      onClick: handleClick,
...
//# sourceMappingURL=index-8cfeb0c0.js.map
