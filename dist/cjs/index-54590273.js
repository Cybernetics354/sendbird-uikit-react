...
var index$1 = require('./index-9855395f.js');
...
var ConnectedUserProfile = SendbirdSdkContext.withSendbirdContext(UserProfile, mapStoreToProps);
...
class MenuItems$1 extends React.Component {
  constructor(props) {
    ...
    SendbirdSdkContext._defineProperty(this, "showParent", () => {
      const {
        parentContainRef = {}
      } = this.props;
      const {
    ...
    SendbirdSdkContext._defineProperty(this, "hideParent", () => {
      const {
        parentContainRef = {}
      } = this.props;
      const {
    ...
    SendbirdSdkContext._defineProperty(this, "setupEvents", () => {
      const {
        closeDropdown
      } = this.props;
      const {
    ...
    SendbirdSdkContext._defineProperty(this, "cleanUpEvents", () => {
      const {
        handleClickOutside
      } = this.state;
    ...
    SendbirdSdkContext._defineProperty(this, "getMenuPosition", () => {
      const {
        parentRef,
        openLeft
      } = this.props;
  ...
  render() {
    ...
    return /*#__PURE__*/reactDom.createPortal( /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      ref: this.menuRef,
      style: SendbirdSdkContext._objectSpread2({
...
class EmojiListItems$1 extends React.Component {
  constructor(props) {
    ...
    SendbirdSdkContext._defineProperty(this, "getBarPosition", () => {
...
const IconButton = /*#__PURE__*/React__default["default"].forwardRef((props, ref) => {
  ...
  return (
    ...
    React__default["default"].createElement("button", {
      ...
      ,
      style: SendbirdSdkContext._objectSpread2(SendbirdSdkContext._objectSpread2({}, style), {}, {
        height,
        width
      }),
      onClick: e => {
...
//# sourceMappingURL=index-54590273.js.map
