import React__default, { useContext, useMemo, useRef, useState, useLayoutEffect, useEffect, useCallback, Component, useReducer } from 'react';
import PropTypes from 'prop-types';
import { f as format, i as isSameDay } from './index-b3ce6401.js';
import { C as ContextMenu, I as IconButton, M as MenuItems, a as MenuItem, E as EmojiListItems, T as TextButton, U as UserProfileContext, b as ConnectedUserProfile, c as Modal, B as ButtonTypes, S as SEND_USER_MESSAGE, d as SEND_MESSAGE_START, e as SEND_FILE_MESSAGE, f as UPDATE_USER_MESSAGE, D as DELETE_MESSAGE, g as UserProfileProvider } from './index-fac6acf6.js';
import { g as getOutgoingMessageStates, a as getOutgoingMessageState, i as isSentStatus, b as isUserMessage, c as isFailedMessage, d as isPendingMessage, e as isSentMessage, f as getClassName, h as copyToClipboard, j as getEmojiListAll, k as getEmojiMapAll, l as isReactedBy, m as getEmojiTooltipString, n as isEditedMessage, o as getUIKitFileType, t as truncateString, p as isVideoMessage, q as isGifMessage, r as isUrl, s as getUIKitFileTypes, u as isThumbnailMessage, v as isVideo, w as isGif, x as isFileMessage, y as isSupportedFileView, z as getUIKitMessageTypes, A as getSenderName, B as isTextMessage, C as isOGMessage, D as getUIKitMessageType, E as getSendingMessageStatus, F as filterMessageListParams, G as isImageMessage, H as isAudioMessage } from './index-7739d6e2.js';
import { L as LocalizationContext, u as uuidv4, _ as _objectSpread2, a as _defineProperty, w as withSendbirdContext } from './SendbirdSdkContext-d0ef7c7c.js';
import { L as LinkLabel, D as DateSeparator, M as MessageInput, F as FileViewer, c as compareIds } from './compareIds-86398458.js';
import { I as IconTypes, a as IconColors, L as Loader, b as Icon, c as Label, d as LabelTypography, e as LabelColors, f as ImageRenderer, A as Avatar, P as PlaceHolder, g as PlaceHolderTypes, h as LabelStringSet } from './index-acb952b8.js';
import { C as ChannelAvatar } from './index-1f37a0d4.js';
...
export { Conversation as C, MessageHoc as M, getAllEmojisFromEmojiContainer as a, getEmojisFromEmojiContainer as b, ConversationPanel as c, getEmojiCategoriesFromEmojiContainer as g, reducer as r };
//# sourceMappingURL=index-226de335.js.map
