...
var index$3 = require('./index-54590273.js');
var index = require('./index-9855395f.js');
var SendbirdSdkContext = require('./SendbirdSdkContext-89d804b3.js');
var compareIds = require('./compareIds-074cb64a.js');
var index$1 = require('./index-de107146.js');
...
function MessageStatus(_ref) {
  ...
  const iconType = {
    [MessageStatusTypes.SENT]: index$1.IconTypes.DONE,
    [MessageStatusTypes.DELIVERED]: index$1.IconTypes.DONE_ALL,
    [MessageStatusTypes.READ]: index$1.IconTypes.DONE_ALL,
    [MessageStatusTypes.FAILED]: index$1.IconTypes.ERROR
  };
  const iconColor = {
    [MessageStatusTypes.SENT]: index$1.IconColors.SENT,
    [MessageStatusTypes.DELIVERED]: index$1.IconColors.SENT,
    [MessageStatusTypes.READ]: index$1.IconColors.READ,
    [MessageStatusTypes.FAILED]: index$1.IconColors.ERROR
  };
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, showMessageStatusIcon && (messageStatus === MessageStatusTypes.PENDING ? /*#__PURE__*/React__default["default"].createElement(index$1.Loader, {
    ...
    className: "sendbird-message-status__icon",
    type: iconType[messageStatus] || index$1.IconTypes.ERROR,
    fillColor: iconColor[messageStatus],
    width: "16px",
    height: "16px"
  })), index.isSentStatus(messageStatus) && /*#__PURE__*/React__default["default"].createElement(index$1.Label, {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    menuItems: function (close) {
      ...
      return /*#__PURE__*/React__default["default"].createElement(index$3.MenuItems, {
        ...
        openLeft: isByMe
      }, showMenuItemCopy && /*#__PURE__*/React__default["default"].createElement(index$3.MenuItem, {
      ...
      }, stringSet.MESSAGE_MENU__COPY), showMenuItemReply && /*#__PURE__*/React__default["default"].createElement(index$3.MenuItem, {
      ...
      }, stringSet.MESSAGE_MENU__REPLY), showMenuItemEdit && /*#__PURE__*/React__default["default"].createElement(index$3.MenuItem, {
      ...
      }, stringSet.MESSAGE_MENU__EDIT), showMenuItemResend && /*#__PURE__*/React__default["default"].createElement(index$3.MenuItem, {
      ...
      }, stringSet.MESSAGE_MENU__RESEND), showMenuItemDelete && /*#__PURE__*/React__default["default"].createElement(index$3.MenuItem, {
...
function MessageItemReactionMenu(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    menuItems: function (close) {
      ...
      return /*#__PURE__*/React__default["default"].createElement(index$3.EmojiListItems, {
        parentRef: triggerRef,
        parentContainRef: containerRef,
        closeDropdown: closeDropdown,
...
function EmojiReactions2(_a) {
  ...
  }), ((_c = message === null || message === void 0 ? void 0 : message.reactions) === null || _c === void 0 ? void 0 : _c.length) < emojisMap.size && /*#__PURE__*/React__default["default"].createElement(index$3.ContextMenu, {
    menuTrigger: function (toggleDropdown) {
...
function TextMessageItemBody(_a) {
  ...
  }, message === null || message === void 0 ? void 0 : message.message, index.isEditedMessage(message) && /*#__PURE__*/React__default["default"].createElement(index$1.Label, {
...
function ThumbnailMessageItemBody(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    fillColor: index$1.IconColors.GRAY,
    width: "34px",
    height: "34px"
  }))));
}
...
function OGMessageItemBody(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    return index.isUrl(word) ? /*#__PURE__*/React__default["default"].createElement(compareIds.LinkLabel, {
...
function QuoteMessage(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    defaultComponent: /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      type: index.isVideo(parentMessageType) ? index$1.IconTypes.PLAY : index$1.IconTypes.PHOTO,
      fillColor: index$1.IconColors.ON_BACKGROUND_2,
      width: "22px",
      height: "22px"
    })))
    ...
    type: (_b = {}, _b[uikitFileTypes.IMAGE] = index$1.IconTypes.PHOTO, _b[uikitFileTypes.VIDEO] = index$1.IconTypes.PLAY, _b[uikitFileTypes.AUDIO] = index$1.IconTypes.FILE_AUDIO, _b[uikitFileTypes.GIF] = index$1.IconTypes.GIF, _b[uikitFileTypes.OTHERS] = index$1.IconTypes.FILE_DOCUMENT, _b)[index.getUIKitFileType(parentMessageType)],
    fillColor: index$1.IconColors.ON_BACKGROUND_3,
    width: "16px",
    height: "16px"
  }), /*#__PURE__*/React__default["default"].createElement(index$1.Label, {
...
function MessageContent(_a) {
  ...
  var _j = React.useContext(index$3.UserProfileContext),
      disableUserProfile = _j.disableUserProfile,
      renderUserProfile = _j.renderUserProfile;

  var dateLocale = React.useContext(SendbirdSdkContext.LocalizationContext).dateLocale;
  ...
  /** user profile */
  React__default["default"].createElement(index$3.ContextMenu, {
    menuTrigger: function (toggleDropdown) {
      var _a;
  ...
  }, !isByMe && !chainTop && !useReplying && /*#__PURE__*/React__default["default"].createElement(index$1.Label, {
...
const RemoveMessage = props => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(index$3.Modal, {
    type: index$3.ButtonTypes.DANGER,
...
function MessageHoc(_ref) {
  ...
  if (RenderedMessage) {
    ...
    }, hasSeparator && /*#__PURE__*/React__default["default"].createElement(compareIds.DateSeparator, null, /*#__PURE__*/React__default["default"].createElement(index$1.Label, {
      type: index$1.LabelTypography.CAPTION_2,
      color: index$1.LabelColors.ONBACKGROUND_2
  ...
  if (showEdit) {
    return /*#__PURE__*/React__default["default"].createElement(compareIds.MessageInput, {
      isEdit: true,
  ...
  }), showFileViewer && /*#__PURE__*/React__default["default"].createElement(compareIds.FileViewer, {
...
const pubSubHandler = (channelUrl, pubSub, dispatcher) => {
  ...
  subscriber.set(index$3.SEND_USER_MESSAGE, pubSub.subscribe(index$3.SEND_USER_MESSAGE, msg => {
    const {
      channel,
      message
    } = msg;
  ...
  subscriber.set(index$3.SEND_MESSAGE_START, pubSub.subscribe(index$3.SEND_MESSAGE_START, msg => {
    const {
      channel,
      message
    } = msg;
  ...
  subscriber.set(index$3.SEND_FILE_MESSAGE, pubSub.subscribe(index$3.SEND_FILE_MESSAGE, msg => {
    const {
      channel,
      message
    } = msg;
  ...
  subscriber.set(index$3.UPDATE_USER_MESSAGE, pubSub.subscribe(index$3.UPDATE_USER_MESSAGE, msg => {
    const {
      channel,
      message,
      fromSelector
  ...
  subscriber.set(index$3.DELETE_MESSAGE, pubSub.subscribe(index$3.DELETE_MESSAGE, msg => {
    const {
      channel,
      messageId
    } = msg;
...
function reducer(state, action) {
  switch (action.type) {
    ...
    case GET_PREV_MESSAGES_SUCESS:
      {
        ...
        const filteredNewMessages = duplicatedMessageIds.length > 0 ? receivedMessages.filter(msg => !duplicatedMessageIds.find(messageId => compareIds.compareIds(messageId, msg.messageId))) : receivedMessages;
        ...
        return SendbirdSdkContext._objectSpread2(SendbirdSdkContext._objectSpread2(SendbirdSdkContext._objectSpread2(SendbirdSdkContext._objectSpread2({}, state), {}, {
          loading: false,
          initialized: true,
    ...
    case GET_NEXT_MESSAGES_FAILURE:
      {
        return SendbirdSdkContext._objectSpread2({}, state);
      }

    case SEND_MESSAGEGE_START:
      return SendbirdSdkContext._objectSpread2(SendbirdSdkContext._objectSpread2({}, state), {}, {
        allMessages: [...state.allMessages, SendbirdSdkContext._objectSpread2({}, action.payload)]
      });
    ...
    case ON_MESSAGE_UPDATED:
      {
        ...
        return SendbirdSdkContext._objectSpread2(SendbirdSdkContext._objectSpread2({}, state), {}, {
          allMessages: state.allMessages.map(m => compareIds.compareIds(m.messageId, action.payload.message.messageId) ? action.payload.message : m)
        });
      }
    ...
    case ON_MESSAGE_THREAD_INFO_UPDATED:
      {
        ...
        if (!compareIds.compareIds(channel.url, currentGroupChannelUrl) || !compareIds.compareIds(channel.url, channelUrl)) {
          return state; // Ignore event when it is not for the current channel
        }
...
function useHandleChannelEvents(_ref, _ref2) {
  ...
  React.useEffect(() => {
    const messageReceiverId = SendbirdSdkContext.uuidv4();
    ...
    if (channelUrl && sdk && sdk.ChannelHandler) {
      ...
      ChannelHandler.onMessageReceived = (channel, message) => {
        ...
        if (compareIds.compareIds(channel.url, channelUrl) && !hasMoreToBottom) {
  ...
  return React.useCallback((messageId, text, cb) => {
    ...
    currentGroupChannel.updateUserMessage(messageId, params, (r, e) => {
      ...
      if (!err) {
        ...
        pubSub.publish(index$3.UPDATE_USER_MESSAGE, {
          message,
          channel: currentGroupChannel
        });
      } else {
...
function useSendMessageCallback(_ref, _ref2) {
  ...
  const sendMessage = React.useCallback(function () {
    ...
    pubSub.publish(index$3.SEND_MESSAGE_START, {
  ...
  const sendMessage = React.useCallback(function (file) {
    ...
    if (canCompressImage) {
        ...
        image.onload = () => {
          ...
          context.canvas.toBlob(newImageBlob => {
            ...
            pubSub.publish(index$3.SEND_MESSAGE_START, {
              /* pubSub is used instead of messagesDispatcher
                to avoid redundantly calling `messageActionTypes.SEND_MESSAGEGE_START` */
              message: SendbirdSdkContext._objectSpread2(SendbirdSdkContext._objectSpread2({}, pendingMessage), {}, {
      ...
      pubSub.publish(index$3.SEND_MESSAGE_START, {
        /* pubSub is used instead of messagesDispatcher
          to avoid redundantly calling `messageActionTypes.SEND_MESSAGEGE_START` */
        message: SendbirdSdkContext._objectSpread2(SendbirdSdkContext._objectSpread2({}, pendingMsg), {}, {
...
class ConversationScroll extends React.Component {
  constructor(props) {
    ...
    SendbirdSdkContext._defineProperty(this, "handleScroll", () => {
      const {
        scrollRef
    ...
    SendbirdSdkContext._defineProperty(this, "onScroll", e => {
      const {
        scrollRef,
        hasMore,
        messagesDispatcher,
      ...
      setTimeout(() => {
        ...
        if (scrollRef !== null && scrollRef !== void 0 && scrollRef.current) {
          const current = scrollRef === null || scrollRef === void 0 ? void 0 : scrollRef.current;
          this.setState(state => SendbirdSdkContext._objectSpread2(SendbirdSdkContext._objectSpread2({}, state), {}, {
...
function Notification(_ref) {
  ...
  return (
    ...
    React__default["default"].createElement("div", {
      ...
      color: index$1.LabelColors.ONCONTENT_1,
      type: index$1.LabelTypography.CAPTION_2
    }, `${count} `, stringSet.CHANNEL__MESSAGE_LIST__NOTIFICATION__NEW_MESSAGE, ` ${timeArray.join(' ')}`), /*#__PURE__*/React__default["default"].createElement(index$1.Icon, {
      width: "24px",
      height: "24px",
      type: index$1.IconTypes.CHEVRON_DOWN,
...
function TypingIndicator(props) {
  ...
  const [handlerId, setHandlerId] = React.useState(SendbirdSdkContext.uuidv4());
  const [typingMembers, setTypingMembers] = React.useState([]);
  React.useEffect(() => {
    if (sb && sb.ChannelHandler) {
      sb.removeChannelHandler(handlerId);
      const newHandlerId = SendbirdSdkContext.uuidv4();
...
function QuoteMessageThumbnail(_a) {
  ...
  if (index.isThumbnailMessage(message) && thumbnailUrl) {
    return /*#__PURE__*/React__default["default"].createElement(index$1.ImageRenderer, {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      type: index$1.IconTypes.FILE_AUDIO,
      fillColor: index$1.IconColors.ON_BACKGROUND_2,
      width: "24px",
      height: "24px"
    }));
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      type: index$1.IconTypes.FILE_DOCUMENT,
      fillColor: index$1.IconColors.ON_BACKGROUND_2,
      width: "24px",
      height: "24px"
    }));
...
function QuoteMessageInput(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    color: index$1.LabelColors.ONBACKGROUND_1
  }, "".concat(stringSet.QUOTE_MESSAGE_INPUT__REPLY_TO, " ").concat(sender && sender.nickname ? sender.nickname : stringSet.NO_NAME)), /*#__PURE__*/React__default["default"].createElement(index$1.Label, {
    className: "sendbird-quote_message_input__body__message-content",
    type: index$1.LabelTypography.BODY_2,
    color: index$1.LabelColors.ONBACKGROUND_3
  }, index.isImageMessage(fileMessage) && !index.isGifMessage(fileMessage) && stringSet.QUOTE_MESSAGE_INPUT__FILE_TYPE_IMAGE, index.isVideoMessage(fileMessage) && stringSet.QUOTE_MESSAGE_INPUT__FILE_TYPE__VIDEO, index.isGifMessage(fileMessage) && stringSet.QUOTE_MESSAGE_INPUT__FILE_TYPE_GIF, index.isUserMessage(replyingMessage) && replyingMessage.message, index.isFileMessage(fileMessage) && !index.isThumbnailMessage(fileMessage) && fileMessage.name)), /*#__PURE__*/React__default["default"].createElement(index$1.Icon, {
...
var MessageInputWrapper = function (_a, ref) {
  ...
  })), /*#__PURE__*/React__default["default"].createElement(compareIds.MessageInput, {
...
const getChannelTitle = function () {
  ...
  let stringSet = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : index$1.LabelStringSet;
...
function ChatHeader(props) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    width: "24px",
    height: "24px"
  }), showSearchIcon && /*#__PURE__*/React__default["default"].createElement(index$3.IconButton, {
...
var Conversation = SendbirdSdkContext.withSendbirdContext(ConversationPanel);

exports.Conversation = Conversation;
exports.ConversationPanel = ConversationPanel;
exports.MessageHoc = MessageHoc;
...
//# sourceMappingURL=index-ed6104c5.js.map
